...
export default function VoltPak2000ProPage() {
  ...
  const configurations = {
    standard: {
      ...
      price: 2499,
      description: "Complete VoltPak 2000 Pro with all essential features",
      includes: [
        "VoltPak 2000 Pro Unit",
        "AC Charging Cable",
        "User Manual",
        "1-Year Warranty",
      ],
    ...
    solar: {
      name: "Solar Bundle",
      price: 3099,
      description: "VoltPak 2000 Pro with integrated solar charging capability",
      includes: [
        "VoltPak 2000 Pro Unit",
        "400W Solar Panel",
        "MPPT Controller",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      <Navigation />
      <ProductNavigation productName="VoltPak 2000W UPS Inverter" />
      ...
      <div className="pt-32">
        ...
        <div className="container mx-auto px-4 py-4">
          <nav className="text-sm text-blue-300">
            ...
            <span className="text-white">VoltPak 2000 Pro</span>
          </nav>
        </div>
              ...
              >
                <div>
                  ...
                  <p className="text-xl text-blue-200 leading-relaxed mb-6">
                    Professional-grade portable power station with 2000W pure
